...
//    }
  ...
  this.setLocalDescription = function setLocalDescription(description, successCallback, failureCallback) {
    ...
    if(typeof(localType) === 'undefined' || typeof(description.sdp) === 'undefined') {
      throw "description must be an object of type: {type: ... , sdp: ... }"
    }
  ...
  this.setRemoteDescription = function setRemoteDescription(description, successCallback, failureCallback) {
    ...
    if(typeof(remoteType) === 'undefined' || typeof(description.sdp) === 'undefined') {
      throw "description must be an object of type: {type: ... , sdp: ... }"
    }
  ...
  this.addIceCandidate = function addIceCandidate(candidate, successCallback, failureCallback) {
    if(typeof(candidate.candidate) === 'undefined' || typeof(candidate.sdpMid) === 'undefined' || typeof(candidate.sdpMLineIndex) === 'undefined')) {
      throw "candidate must be an object of type: {candidate: ... , sdpMid: ... , sdpMLineInidex: ...}"
    }
